...
export default function Onboarding() {
 const navigate = useNavigate()
  ...
  return (
    <div className="bg-[rgb(255,255,255)] py-5 flex flex-col justify-between h-screen overflow-auto ">
      {/* Logo */}
      <div className="flex fixed top-0 w-full bg-[#fff] items-center gap-2 mb-12 border-b border-b-gray-300 pt-5 ">
        <img
          ...
          className="pb-5 px-10 md:w-[15%] w-[50%]"
        />
      </div>
      <div className="md:px-7 px-8 lg:mt-25 mt-20 overflow-auto">
        {/* Heading */}
        ...
        <p className="text-gray-600 text-[12px] mt-2 text-left">
         Create your account to take control of your finances and access smart banking services.
        </p>
